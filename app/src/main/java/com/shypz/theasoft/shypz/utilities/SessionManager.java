...
/**
 * Created by H216104 on 11/27/2017.
 */
...
public class SessionManager {
    ...
    private static final String PREF_NAME = Constants.MyPREFERENCES;

    // All Shared Preferences Keys
    private static final String IS_LOGIN = Constants.IsLoggedIn;

    // User name (make variable public to access from outside)
    public static final String KEY_NAME = Constants.userNameKey;

    // Email address (make variable public to access from outside)
    public static final String KEY_EMAIL = Constants.userEmailKey;

    // Mobile (make variable public to access from outside)
    public static final String KEY_MOBILE = Constants.userMobileKey;
